...
async function mcpExecute() {
  ...
  console.log(`🚀 MCP AGENT EXECUTION`);
  console.log(`Agent ID: 4fe39d22-5043-40d3-b2a1-dd8968ecf8a6`);
  ...
  try {
    ...
    const result = {
      ...
      agentId: '4fe39d22-5043-40d3-b2a1-dd8968ecf8a6',
      network: 'devnet',
    ...
    fs.writeFileSync('.cache/mcp-agent-result.json', JSON.stringify(result, null, 2));
...
mcpExecute().catch(console.error);